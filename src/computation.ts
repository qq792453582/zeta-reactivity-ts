...
import { ConsumerNode, tracked, trackedApply } from "./consumer";
import { producerAccessed, ProducerNode } from "./producer";
...
export class ComputationNode extends ConsumerNode {
	...
	constructor(protected options?: ComputationOptions) {
		super();
